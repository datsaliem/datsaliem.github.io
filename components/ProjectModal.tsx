...
const ProjectModal: React.FC<ProjectModalProps> = ({ project, onClose }) => {
  ...
  return (
    ...
    >
      <div 
        className="bg-slate-800 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto p-8 border border-slate-700 relative transform transition-all duration-300 scale-95 opacity-0 animate-fade-in-scale"
